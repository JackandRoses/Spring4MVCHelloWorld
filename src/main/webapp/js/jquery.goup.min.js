...
(function(e) {
	...
	e.goup = function(n) {
		...
		e("body").append(
				'<div style="display:none" class="' + r.containerClass
						+ '"></div>');
		...
		if (!r.titleAsText) {
			...
			e("body").append(
					'<div class="' + r.titleAsTextClass + '">' + r.title
							+ "</div>");
			var m = e("." + r.titleAsTextClass);
			e(m).attr("style", e(i).attr("style"));
			e(m).css("background", "transparent").css("width", 80).css(
					"height", "auto").css("text-align", "center")
					.css(o, u - 20);
			var g = e(m).height() + 10;
			e(i).css("bottom", "+=" + g + "px")
		}
